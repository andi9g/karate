    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item hoverku">
              <a href="{{ url('pendaftar', []) }}" class="nav-link @yield('activekuPendaftar')">
            ...
            <li class="nav-item hoverku">
              <a href="{{ url('lomba', []) }}" class="nav-link @yield('activekuLomba')">
            ...
            <li class="nav-item hoverku">
              <a href="{{ url('lapangan', []) }}" class="nav-link @yield('activekulapangan')">
